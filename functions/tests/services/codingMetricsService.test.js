...
describe('codingMetrics', () => {
  ...
  it('should return a list of coding metrics', async () => {
    ...
    expect(mockGet).toHaveBeenCalledWith(`https://flow.pluralsight.com/v3/customer/metrics/code_fundamentals/period_metrics/?start_date=2023-11-18&end_date=2023-11-25&team_id=${singleTeam?.id}&include_nested_teams=true&resolution=period`);
